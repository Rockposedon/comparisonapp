            ...
            <p class="card-text">
              ...
              try {
                ...
                if ($html) {
                  ...
                  echo "Error fetching data from Flipkart";
                }
              } catch (Exception $e) {
            ...
            <p class="card-text">
              ...
              try {
                ...
                if ($html) {
                  ...
                  echo "Error fetching data from Amazon";
                }
              } catch (Exception $e) {
                echo "Error: " . $e->getMessage();
              }
            ...
            <p class="card-text">
              ...
              try {
                ...
                if ($html) {
                  ...
                  echo "Error fetching data from Snapdeal";
                }
              } catch (Exception $e) {
                echo "Error: " . $e->getMessage();
              }
...
<footer class="page-footer font-small pt-4 btn-dark">
  ...
  <div class="footer-copyright text-center py-3">© 2024 Copyright:
    <a href=""> Created by Pranjal and Vaishnavi</a>
  </div>
  <!-- Copyright -->
